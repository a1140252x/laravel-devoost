...
const openModal = ( orderId, itemId ) => {
...
function submit() {
    form.put( route('orders.update', order_id.value), {
        onSuccess: (response) => {
            closeModal();
            emit('deleted', response.props.flash.id );
            form.reset();
            showToast()
        }
    });
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Seguro que quieres quitar el producto de la orden?</h3>
...
<div class="fixed bottom-4 left-1/2 -translate-x-1/2 z-50">
    <div v-if="showingToast" id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        <div class="ms-3 text-sm font-normal">PRODUCTO ELIMINADO DE LA ORDEN</div>
